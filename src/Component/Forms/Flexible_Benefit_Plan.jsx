                    ...
                    <div class="card-body">
                      ...
                      >
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-4">
                          <div className="form-group">                               
                                  <label >Telephone Allowance <span className="text-danger mt-2">
                                  {selectedBand === "Band 2"
                                    ? "(Max 2000) "
                                    : selectedBand === "Band 3"
                                    ? "(Max 3000) "
                          ...
                          <div className="form-group">
                                  ...
                                  <label >Fuel <span className="col-4 text-danger mt-2">
                                  {selectedBand === "Band 2"
                                    ? "(Max 3000) "
                                    : selectedBand === "Band 3"
                                    ? "(Max 5000) "
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-4">
                          <div className="form-group">
                                    <label >Meals Allowance <span className="col-4 text-danger mt-2">
                                  {selectedBand === "Band 2"
                                    ? "(Max 2000) "
                                    : selectedBand === "Band 3"
                                    ? "(Max 3000) "
                          ...
                          <div className="form-group">
                                    <label >
                                    Books and Periodicals <span className=" text-danger mt-2">
                                  {selectedBand === "Band 2"
                                    ? "(Max 1500)"
                                    : selectedBand === "Band 3"
                                    ? "(Max 2000) "
                          ...
                          {selectedBand === "Band 4" &&
                              <div className="form-group">
                                    ...
                                    <label >Driver <span className="col-4 text-danger mt-2">
                                    {selectedBand === "Band 4"
                                      ? "(Max 8000)"
                                      : ""}
                                  </span></label>  <input
