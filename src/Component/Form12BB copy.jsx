...
const Form12BB = () => {
  ...
  const [inputData, setInputData] = useState({
    ...
    permanent_account_number_of_the_employee:
      getFormDataByID?.permanent_account_number_of_the_employee === undefined
        ? "A123456789"
        : " ",
    father_name: " ",
    place: " ",
  ...
  const onSaveButton = (e) => {
    ...
    async function postData() {
      ...
      if (inputData?.status === undefined) {
        ...
        const resp = result.data;
        alert(resp.message);
        if (resp?.message === "Form has been updated") {
          navigate("/");
        }
        setLoading(false);
      }
                            ...
                            <>
                              ...
                              <div class="form-group">
                                ...
                                <small>
                                  ...
                                  the aggregate rent paid during the previous
                          ...
                          {leavetravelconcessionsorassistance && (
                            <>
                              ...
                              <div class="form-group">
                                ...
                                <small>
                                  <span className="text-danger">Note</span> :
                                  LTA can be claim only twice in 4 years as per
                                  IT Laws.
                                </small>
                              </div>
                            </>
