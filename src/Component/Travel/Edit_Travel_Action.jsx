    ...
    const get_travel_request_by_id = async () => {
      ...
      const res = await axios
        ...
        .then((res) => {
          ...
          return (
            console.log("res.data", res?.data?.roomsData),
            setBasicDetails(res?.data?.basicDetails),
            setRoomsData(
              res?.data?.roomsData?.map((val) => {
                return {
                  ...val,
                  data: {
                    ...val?.data,
            ...
            setTravellersData(
              res?.data?.travellersData?.map((val) => {
                return {
                  ...val,
                  data: {
                    ...val.data,
            ...
            setRows(
              res?.data?.rows?.map((val) => {
                return {
                  ...
                  data: {
                    ...val?.data,
                    departure: val?.data?.departure?.split("T")[0],
                  },
                };
              })
            ),
            setAccommodationData(
              res?.data?.accommodationData?.map((val) => {
                return {
                  ...val,
                  data: {
                    ...val?.data,
                    checkIn: val?.data?.checkIn?.split("T")[0],
                    checkOut: val?.data?.checkOut?.split("T")[0],
                  },
                };
              })
            )
...
export default Edit_Travel_Action;
