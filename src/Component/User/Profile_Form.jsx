...
import { FirstName } from "./Profile_Update";
const Profile_Form = ({ multiselect_disabled, status_hide }) => {
  ...
  useEffect(() => {
    async function get_user_data() {
      const result_get_user_data = await axios(
    ...
    async function get_department_list() {
      ...
      setGetDepartmentList(resp_get_department_list);
    }
    get_department_list();
  }, []);
    ...
    <>
      <form class="forms-sample">
        ...
        <div className="row">
          ...
          <div className="col-md-3">
            <div class="form-group">
              <label> emergency_contact_person_relationship </label>
              <input
                type="text"
                name="emergency_contact_person_relationship"
                class="form-control form-control-sm"
                onChange={inputEvent}
                value={inputData?.emergency_contact_person_relationship}
              />
            </div>
          </div>
          <div className="col-md-3">
          ...
          <div className="col-md-3">
            <div class="form-group">
              ...
              <select
                ...
                class="form-control form-control-sm"
                onChange={inputEvent}
                value={inputData?.vaccination_certificate_provided}
              >
                <option value="">--Select--</option>
                <option value={1}>Yes</option>
                <option value={0}>No</option>
